...
fullcheck.py check the weather commits collected use signing commit collected. countsign.py calculates how many commit uses signing commnt and how many not.
